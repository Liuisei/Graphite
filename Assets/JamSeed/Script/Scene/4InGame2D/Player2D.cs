...
public class Player2D : MonoBehaviour
{
    ...
    {
        var cloneObj = Instantiate(PlayerClone, transform.position, Quaternion.Euler(0f, -90f, 0f));
        PlayerClone cloneScript = cloneObj.GetComponent<PlayerClone>();
        cloneScript.SetLevel(level);
    }
}